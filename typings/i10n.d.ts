...
export type FluentMessageId =
  ...
  | 'item-tree-column-mineru-parse-unparsed'
  ...
  | 'parse-task-download-reconnect'
  | 'parse-task-finished'
  | 'parse-task-finished-progress'
  | 'parse-task-reconnect'
