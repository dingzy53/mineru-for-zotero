...
pref-attach-layout-pdf =
    .label = Generate and attach visual box PDF
pref-attach-layout-pdf-help = Automatically generate an annotated PDF with layout bounding boxes and attach it as a child item upon parse completion.
