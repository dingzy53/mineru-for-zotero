...
parse-task-reconnect = Local MinerU connection interrupted; reconnecting (attempt { $attempt }, in { $seconds }s)
parse-task-download-reconnect = Local MinerU result download interrupted; reconnecting (attempt { $attempt }, in { $seconds }s)
